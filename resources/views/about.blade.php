...
<head>
    ...
    <title>About Us - Business Control Systems</title>
        ...
        <nav class="container mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden lg:flex items-center space-x-8">
                    ...
                    <a href="/about" class="nav-link active text-blue-600 font-medium">About</a>
            ...
            <div id="mobile-menu" class="lg:hidden hidden mt-4 pb-4 border-t border-gray-200">
                <div class="flex flex-col space-y-4 pt-4">
                    ...
                    <a href="/about" class="text-blue-600 font-medium py-2">About</a>
                ...
                <div class="bg-white rounded-3xl p-12 shadow-2xl">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="text-center">
                            ...
                            <p class="text-gray-600">101 E 5th Street<br>Loveland, CO 80537</p>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-gray-600">(800) 233-5876 Ext. 233<br>(732) 283-1300</p>
                        </div>
                    </div>
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="/about" class="text-blue-400 font-medium">About Us</a></li>
