        ...
        <div class="container mx-auto px-6 relative z-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
                ...
                <div class="retail-card text-center p-8 rounded-3xl bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300">
                    ...
                    <button class="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300">
                        Learn More
                    </button>
                </div>
                ...
                <div class="retail-card text-center p-8 rounded-3xl bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300">
                    ...
                    <button class="bg-gradient-to-r from-green-500 to-blue-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300">
                        Learn More
                    </button>
                </div>
                ...
                <div class="retail-card text-center p-8 rounded-3xl bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300">
                    ...
                    <button class="bg-gradient-to-r from-purple-500 to-pink-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300">
                        Learn More
                    </button>
                </div>
            </div>
            ...
            <div class="text-center">
                <p class="text-gray-300 mb-6 max-w-3xl mx-auto">
                    Call Business Control Systems today at <strong class="text-white">(800) 233-5876 Ext. 233</strong> to find out how properly configured point of sale systems and inventory control software can help your business attain peak efficiency.
                </p>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
                <div class="text-center group">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Honesty</h3>
                    <p class="text-gray-600">Transparent pricing, honest communication, and trustworthy partnerships with every client.</p>
                </div>
                <div class="text-center group">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Value</h3>
                    <p class="text-gray-600">Delivering exceptional ROI through cost-effective solutions that drive business growth.</p>
                </div>
                <div class="text-center group">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Pride</h3>
                    <p class="text-gray-600">Taking pride in every solution we deliver, ensuring excellence in every detail.</p>
                </div>
                <div class="text-center group">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Fairness</h3>
                    <p class="text-gray-600">Fair treatment for all customers, equitable pricing, and balanced business relationships.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2">North America</h3>
                    <p class="text-gray-600 text-sm">5,000+ Businesses</p>
                </div>
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2">Europe</h3>
                    <p class="text-gray-600 text-sm">3,000+ Businesses</p>
                </div>
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2">Asia Pacific</h3>
                    <p class="text-gray-600 text-sm">2,000+ Businesses</p>
                </div>
                <div class="text-center">
